...
def select(population, to_retain):
    """Cull a population to tretain only a specific number of members."""
...
def breed(males, females, litter_size):
    """Crossover egnes among members (weights) of a population."""
...
def main():
    ...
    while popl_fitness < 1 and generations < GENERATION_LIMIT:
        ...
        popl_fitness = fitness(parents, GOAL)
        print("Generation {} fitness 0 {:.4f}".format(generations, popl_fitness))
